...
--               c:/Users/joebe/Documents/RFSoC/RFSoC-MTS-main_ORIGINAL/RFSoC-MTS-main/boards/RFSoC4x2/build_mts/mts/mts.gen/sources_1/bd/mts/ip/mts_BUFG_PL_CLK_0/mts_BUFG_PL_CLK_0_sim_netlist.vhdl
...
entity mts_BUFG_PL_CLK_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of mts_BUFG_PL_CLK_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of mts_BUFG_PL_CLK_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "BUFG";
  attribute C_MODE : string;
  attribute C_MODE of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of mts_BUFG_PL_CLK_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mts_BUFG_PL_CLK_0_util_ds_buf : entity is "util_ds_buf";
end mts_BUFG_PL_CLK_0_util_ds_buf;

architecture STRUCTURE of mts_BUFG_PL_CLK_0_util_ds_buf is
  signal \<const0>\ : STD_LOGIC;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \USE_BUFG.GEN_BUFG[0].BUFG_U\ : label is "BUFG";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of \USE_BUFG.GEN_BUFG[0].BUFG_U\ : label is "VCC:CE";
...
entity mts_BUFG_PL_CLK_0 is
  ...
  attribute NotValidForBitStream of mts_BUFG_PL_CLK_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mts_BUFG_PL_CLK_0 : entity is "mts_BUFG_PL_CLK_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of mts_BUFG_PL_CLK_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of mts_BUFG_PL_CLK_0 : entity is "util_ds_buf,Vivado 2022.1";
end mts_BUFG_PL_CLK_0;

architecture STRUCTURE of mts_BUFG_PL_CLK_0 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN mts_PL_CLK, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 500000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN mts_PL_CLK, INSERT_VIP 0";
begin
U0: entity work.mts_BUFG_PL_CLK_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
