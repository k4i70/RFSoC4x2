...
HD_PWD='C:/Users/joebe/Documents/RFSoC/RFSoC-MTS-main_ORIGINAL/RFSoC-MTS-main/boards/RFSoC4x2/build_mts/mts/mts.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mts_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mts_wrapper.tcl -notrace
