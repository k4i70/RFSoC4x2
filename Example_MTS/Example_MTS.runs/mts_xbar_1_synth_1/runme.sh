...
HD_PWD='C:/Users/joebe/Documents/RFSoC/RFSoC-MTS-main_ORIGINAL/RFSoC-MTS-main/boards/RFSoC4x2/build_mts/mts/mts.runs/mts_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mts_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mts_xbar_1.tcl
